...
specs_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\calib_mz\moz-calib.xlsx'
...
if choice == 1:
    ...
    calibrated_csv_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\calib_mz\mz-3-country-inputs.csv'

    #messagebox.showinfo('OnSSET', 'Browse to RESULTS folder to save outputs')
    #results_folder = filedialog.askdirectory()
    results_folder = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\calib_mz'
    ...
    summary_folder = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\calib_mz'
    pv_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\mz-2-pv.csv'
