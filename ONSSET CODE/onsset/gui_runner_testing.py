...
specs_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\sl-2-specs_calibrated.xlsx'
...
if choice == 1:
    ...
    calibrated_csv_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\sl-2-country-inputs-calibrated.csv'

    #messagebox.showinfo('OnSSET', 'Browse to RESULTS folder to save outputs')
    #results_folder = filedialog.askdirectory()
    results_folder = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\output'
    ...
    summary_folder = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\output'
    pv_path = r'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\test_data\sl-2-pv.csv'
