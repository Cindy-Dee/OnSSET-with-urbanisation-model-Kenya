...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\andre\OneDrive\Dokument\GitHub\SEforALL-onsset\venv\Scripts\deactivate.nu'
